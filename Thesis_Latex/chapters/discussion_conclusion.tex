...
Evidence from Chapter~5, Section~\ref{sec:results_successful}, indicates that code-specialized models succeeded where larger general-purpose models did not produce usable output. Our LoRA fine-tuned 1.5B model achieved 33\% faster generation and 55\% fewer tokens while producing usable fuzz drivers (see Section~\ref{sec:results_optimization}). These specialized models understood what a fuzz driver should look like because they had seen relevant examples during training.

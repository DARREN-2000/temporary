...
Listing~\ref{lst:appendix_yml} shows the complete GitHub Actions workflow configuration for CI/CD integration with Azure OpenAI, as discussed in Chapter~4, Section~\ref{sec:impl_phase3}. The workflow diagram in Figure~\ref{fig:cicd_workflow} visualizes this pipeline.

...
\textbf{Medium Models (7-14 billion parameters):}
\begin{itemize}
    \item Qwen 2.5-Coder 7B and 14B
    \item DeepSeek Coder V2 Lite 16B
    \item Gemma 3 9B and 27B
\end{itemize}
...
Code-specialized models like Qwen Coder and DeepSeek Coder were trained specifically on programming tasks. General-purpose models like Mixtral were included to investigate whether raw scale could compensate for lack of specialization. This allowed us to test a key hypothesis: does a 46B general model outperform a 7B code-specialized model? Results, discussed in Chapter 5, were surprising: general-purpose models like Mixtral (46.7B) and CodeLlama (34B) achieved 0\% code coverage, while the specialized Qwen 2.5-Coder (32B) and Gemma 3 (27B) consistently achieved over 43\% line coverage.

...
This chapter describes how we turned the methodology from Chapter 3 into working code and systems. The three methodology phases defined in Chapter 3, baseline assessment, model evaluation, and fine-tuning, were implemented as three corresponding development phases: local development, cloud integration, and LoRA fine-tuning. Each phase built on the previous one. We explain the tools we chose, the specific steps we followed, and the engineering decisions we made along the way.

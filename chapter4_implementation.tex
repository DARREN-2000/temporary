...
For the enterprise environment, we used CARIAD's internal GitHub Enterprise instance with self-hosted runners. These runners used Buildah \cite{buildah} instead of Docker for container operations. Buildah is daemonless, which fits better with security policies that restrict long-running processes.
...
We prepared a detailed business case including cost analysis (approximately \texteuro{}74 to \texteuro{}1,452 annually depending on usage) and security risk assessment. This documentation was essential for getting approval.

...
\textbf{Open documentation of outcomes.} We reported not only successes but also which models did not produce usable output and why. This evidence helps others select appropriate models for their use cases.

...
The primary focus of effort turned out to be infrastructure.
...
The security requirement was the most involved to satisfy. Network isolation policies initially required an alternative deployment approach. The Azure Private Link solution addressed this, but required coordination with infrastructure teams. The security requirements are achievable, but organizations should expect integration effort proportional to their security policy complexity.
...
An important finding was the role of infrastructure. We expected the primary focus to be generating good code. In practice, a substantial portion of the project timeline was spent on deploying our solution within the corporate network architecture. Initial approaches including proxy configuration, boundary client integration, and container networking required redesign to align with the enterprise network design. The solution ultimately required organizational support for Azure Private Link architecture.

...
\begin{itemize}
    ...
    \item Connections showing: Code to GH, GH to Firewall, Firewall with Public Internet (Not Used, marked with ❌), Firewall with private connection to Private Link endpoint (marked with ✅), Private Link to LLM Service, LLM returning generated fuzz driver back through the chain
\end{itemize}}}}
\end{figure}
...
However, the qualifications matter. Not all models succeed. General-purpose models, even large ones, frequently did not produce usable output. Model selection matters. In practice, the question ``can LLMs do this'' should really be ``which LLMs can do this, and under what conditions.''
...
This qualification matters. Not all models work. General-purpose models, even large ones, frequently did not produce usable output for this task. Specialized code models like Qwen 2.5-Coder succeeded where others did not. Model selection is a key design decision.

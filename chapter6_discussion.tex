...
Infrastructure integration became a major focus of the implementation effort.
...
\begin{itemize}
    ...
    \item Connections showing: Code to GH, GH to Firewall, Firewall with public internet path not used (marked with ❌), Firewall with private connection to Private Link endpoint (marked with ✅), Private Link to LLM Service, LLM returning generated fuzz driver back through the chain
\end{itemize}}}}
\end{figure}
...
This qualification matters. Not all models work. General-purpose models, even large ones, frequently did not produce usable output for this task. Specialized code models like Qwen 2.5-Coder succeeded where others did not. Model selection is a critical design decision.

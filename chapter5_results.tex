...
\midrule
Yi 34B & Generation hallucinations, 0\% coverage & General-purpose models not suited for specialized code tasks \\
...
On pugixml, Qwen 2.5-Coder 32B achieved 34.77\% coverage, comparable to its yaml-cpp performance (43.08\%). Gemma 3 27B did not achieve any coverage despite consuming significantly more tokens (122k vs 40.2k on yaml-cpp), suggesting the XML parsing API posed challenges that the model was not able to address in this configuration.

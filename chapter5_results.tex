...
The comparative performance of these models is visualized in Figure \ref{fig:model_comparison}, which shows code coverage results across the evaluated models, with Gemma 3 27B and Qwen 2.5-Coder 32B achieving the highest coverage levels (45\% and 43\% respectively), Phi-4 14B at 34\%, and general-purpose models like Yi 34B, DeepSeek R1, and Mixtral 46.7B failing to achieve any coverage.

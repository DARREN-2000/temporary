...
\begin{itemize}
    ...
    \item Estimated time savings: up to 90\% reduction in initial driver creation time (based on comparison of ~30 minute automated generation vs. 2-8 hours of manual writing per target)
\end{itemize}
